# SD MII ICU Koerpertemperatur Brustwirbelsaeule - ISiK Formularmodul Implementation Guide v6.0.0-rc
...
## Resource Profile: SD MII ICU Koerpertemperatur Brustwirbelsaeule 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-brustwirbelsaeule | *Version*:6.0.0-rc |
| Active as of 2025-12-17 | *Computable Name*:SD_MII_ICU_Koerpertemperatur_Brustwirbelsaeule |
...
* Examples for this Profile: [Observation/Koerpertemperatur-Brustwirbelsaeule](Observation-Koerpertemperatur-Brustwirbelsaeule.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/formular|current/StructureDefinition/sd-mii-icu-koerpertemperatur-brustwirbelsaeule)
...
Other representations of profile: [CSV](StructureDefinition-sd-mii-icu-koerpertemperatur-brustwirbelsaeule.csv), [Excel](StructureDefinition-sd-mii-icu-koerpertemperatur-brustwirbelsaeule.xlsx), [Schematron](StructureDefinition-sd-mii-icu-koerpertemperatur-brustwirbelsaeule.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-brustwirbelsaeule",
  "version" : "6.0.0-rc",
  "name" : "SD_MII_ICU_Koerpertemperatur_Brustwirbelsaeule",
