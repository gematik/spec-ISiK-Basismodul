# SD MII ICU Koerpertemperatur Myokard - ISiK Formularmodul Implementation Guide v6.0.0-rc
...
## Resource Profile: SD MII ICU Koerpertemperatur Myokard 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-myokard | *Version*:6.0.0-rc |
| Active as of 2025-12-17 | *Computable Name*:SD_MII_ICU_Koerpertemperatur_Myokard |
...
* Examples for this Profile: [Observation/Koerpertemperatur-Myokard](Observation-Koerpertemperatur-Myokard.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/formular|current/StructureDefinition/sd-mii-icu-koerpertemperatur-myokard)
...
Other representations of profile: [CSV](StructureDefinition-sd-mii-icu-koerpertemperatur-myokard.csv), [Excel](StructureDefinition-sd-mii-icu-koerpertemperatur-myokard.xlsx), [Schematron](StructureDefinition-sd-mii-icu-koerpertemperatur-myokard.sch) 
