# SD MII ICU Koerpertemperatur Stirn - ISiK Formularmodul Implementation Guide v6.0.0-rc
...
## Resource Profile: SD MII ICU Koerpertemperatur Stirn 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-stirn | *Version*:6.0.0-rc |
| Active as of 2025-12-17 | *Computable Name*:SD_MII_ICU_Koerpertemperatur_Stirn |
...
* Examples for this Profile: [Observation/Koerpertemperatur-Stirn](Observation-Koerpertemperatur-Stirn.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/formular|current/StructureDefinition/sd-mii-icu-koerpertemperatur-stirn)
...
Other representations of profile: [CSV](StructureDefinition-sd-mii-icu-koerpertemperatur-stirn.csv), [Excel](StructureDefinition-sd-mii-icu-koerpertemperatur-stirn.xlsx), [Schematron](StructureDefinition-sd-mii-icu-koerpertemperatur-stirn.sch) 
