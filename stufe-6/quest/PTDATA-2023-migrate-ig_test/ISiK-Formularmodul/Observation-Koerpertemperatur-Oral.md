# Example Observation - Koerpertemperatur-Oral - ISiK Formularmodul Implementation Guide v6.0.0-rc
...
## Example Observation: Example Observation - Koerpertemperatur-Oral
...
**code**: Estimated core body temperature measured in sublingual space
