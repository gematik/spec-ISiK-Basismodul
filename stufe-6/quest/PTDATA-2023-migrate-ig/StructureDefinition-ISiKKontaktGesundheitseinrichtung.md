# ISiKKontaktGesundheitseinrichtung - Organspendeerkennung v0.0.1-rc
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKKontaktGesundheitseinrichtung | *Version*:0.0.1-rc |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/Organspendeerkennung.test.ig|current/StructureDefinition/ISiKKontaktGesundheitseinrichtung)
