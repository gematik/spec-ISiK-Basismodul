...
**derivedFrom**: [Response to Questionnaire '->Observation Based Extraction bei quantitativen Angaben' about '->Anna Müller (official) Female, DoB: 1957-08-12 ( Medical record number)'](QuestionnaireResponse-ExampleExtractWithUnitResponse.md)
