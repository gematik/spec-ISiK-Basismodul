# ISiK CapabilityStatement Imports Expectation - ISiK Formularmodul Implementation Guide v6.0.0-rc
...
* Examples for this Extension: [ISiK-CapabilityStatementFormularDatenQuelleAkteur](CapabilityStatement-ISiKCapabilityStatementFormularDatenQuelleAkteur.md) and [ISiK-CapabilityStatementFormularDefinitionsVerwalterAkteur](CapabilityStatement-ISiKCapabilityStatementFormularDefinitionsVerwalterAkteur.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/formular|current/StructureDefinition/ExtensionISiKCapabilityStatementImportsExpectation)
