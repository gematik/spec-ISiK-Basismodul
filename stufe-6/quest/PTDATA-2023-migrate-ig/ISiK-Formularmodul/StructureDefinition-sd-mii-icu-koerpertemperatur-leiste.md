# SD MII ICU Koerpertemperatur Leiste - ISiK Formularmodul Implementation Guide v6.0.0-rc
...
## Resource Profile: SD MII ICU Koerpertemperatur Leiste 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-leiste | *Version*:6.0.0-rc |
| Active as of 2025-12-17 | *Computable Name*:SD_MII_ICU_Koerpertemperatur_Leiste |
...
* Examples for this Profile: [Observation/Koerpertemperatur-Leiste](Observation-Koerpertemperatur-Leiste.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/formular|current/StructureDefinition/sd-mii-icu-koerpertemperatur-leiste)
...
Other representations of profile: [CSV](StructureDefinition-sd-mii-icu-koerpertemperatur-leiste.csv), [Excel](StructureDefinition-sd-mii-icu-koerpertemperatur-leiste.xlsx), [Schematron](StructureDefinition-sd-mii-icu-koerpertemperatur-leiste.sch) 
