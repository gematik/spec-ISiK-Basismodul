# Example QuestionnaireResponse - TestMaxDecimal0 - ISiK Formularmodul Implementation Guide v6.0.0-rc
...
* **Example QuestionnaireResponse - TestMaxDecimal0**

## Example QuestionnaireResponse: Example QuestionnaireResponse - TestMaxDecimal0

Profile: [Ausgefülltes ISiK-Formular](StructureDefinition-ISiKFormularDaten.md)

* [LinkID](https://hl7.org/fhir/R4/formats.html#table): TestMaxDecimal0
