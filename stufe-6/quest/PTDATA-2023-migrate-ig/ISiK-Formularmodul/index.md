# Einführung - ISiK Formularmodul Implementation Guide v6.0.0-rc
...
Die Abstimmung und Diskussion zu diesem Modul findet im [ISiK-Unterforum](https://chat.fhir.org/#streams/287581/german.2Fisik) des [internationalen FHIR-Chats](https://chat.fhir.org/) statt. **Bei der Anlage neuer Diskussionsthemen mit Bezug zu diesem Modul bitte das Präfix `[FORM]` verwenden!**
...
```json
{
  ...
  "id" : "formular",
  "url" : "https://gematik.de/fhir/isik/ImplementationGuide/ISiK-Formularmodul/ImplementationGuide/formular",
  "version" : "6.0.0-rc",
  ...
  "definition" : {
    ...
    "resource" : [
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CapabilityStatement/ISiKCapabilityStatementFormularDefinitionsVerwalterAkteur-expanded"
        },
        "name" : "Akteur &quot;ISiKCapabilityStatementFormularDefinitionsVerwalterAkteur&quot; (Expanded)",
        "description" : "Dieses CapabilityStatement beschreibt alle Interaktionen, \n  die ein System unterstützen MUSS, welches diesen Akteur implementiert.   \n\n  Jede Instanz eines bestätigungsrelevanten Systems MUSS an ihrem Endpunkt eine CapabilityStatement-Ressource bereitstellen.\nHierzu MUSS die [capabilities-Interaktion gemäß FHIR-Kernspezifikation](https://hl7.org/fhir/R4/http.html#capabilities) unterstützt werden. \nDer `MODE`-Parameter kann ignoriert werden.  \nDas CapabilityStatement in dieser Spezifikation stellt die Anforderungen seitens der gematik dar (`kind = requirements`). \nZur Unterscheidung von Rollen, die erfüllt werden MÜSSEN gegenüber jenen, die erfüllt werden KÖNNEN, \nwird die [CapabilityStatement-Imports-Expectation-Extension](https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKCapabilityStatementImportsExpectation) mit den möglichen Werten 'SHALL' (=MUSS)  'SHOULD' (=SOLL)  'MAY' (=KANN) 'SHOULD-NOT' (=SOLL NICHT) verwendet.  \n\nEine Server-Instanz MUSS ihrerseits ein CapabilityStatement vom `kind = instance` liefern und im Element `software` den Namen \nund die Versionsnummer angeben.   \nDarüber hinaus MÜSSEN in `CapabilityStatement.instantiates` sämtliche Canonical URLs der implementierten Rollen angegeben werden.\nDie mindestens zu implementierenden Profile für einen Akteur und Interaktionen entsprechen daher den aggregierten Anforderungen der einzelnen Rolle (per 'imports'). In den CapabilityStatements zu den Rollen sind die Anforderungen tabellarisch gelistet und weisen so die zu implementierenden Profile aus.\n\nDas CapabilityStatement der Instanz MUSS alle Funktionalitäten auflisten, die im folgenden CapabilityStatement (bzw. der in ihm importierten Rollen - siehe 'imports') mit `SHALL` gekennzeichnet sind. \nDas CapabilityStatement KANN darüber hinaus die mit `MAY` gekennzeichneten Funktionalitäten, sowie weitere Funktionalitäten auflisten, \nsofern diese in der Instanz implementiert wurden.  \n\nDie Verwendung der CapabilityStatement-Expectation-Extension ist im CapabilityStatement der Server-Instanz nicht erforderlich."
      },
      {
        "extension" : [
        ...
        "reference" : {
          "reference" : "CapabilityStatement/ISiKCapabilityStatementFormularDefinitionsVerwalterAkteur"
        },
        "name" : "Akteur &quot;ISiKCapabilityStatementFormularDefinitionsVerwalterAkteur&quot;",
        "description" : "Dieses CapabilityStatement beschreibt alle Interaktionen, \n  die ein System unterstützen MUSS, welches diesen Akteur implementiert.   \n\n  Jede Instanz eines bestätigungsrelevanten Systems MUSS an ihrem Endpunkt eine CapabilityStatement-Ressource bereitstellen.\nHierzu MUSS die [capabilities-Interaktion gemäß FHIR-Kernspezifikation](https://hl7.org/fhir/R4/http.html#capabilities) unterstützt werden. \nDer `MODE`-Parameter kann ignoriert werden.  \nDas CapabilityStatement in dieser Spezifikation stellt die Anforderungen seitens der gematik dar (`kind = requirements`). \nZur Unterscheidung von Rollen, die erfüllt werden MÜSSEN gegenüber jenen, die erfüllt werden KÖNNEN, \nwird die [CapabilityStatement-Imports-Expectation-Extension](https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKCapabilityStatementImportsExpectation) mit den möglichen Werten 'SHALL' (=MUSS)  'SHOULD' (=SOLL)  'MAY' (=KANN) 'SHOULD-NOT' (=SOLL NICHT) verwendet.  \n\nEine Server-Instanz MUSS ihrerseits ein CapabilityStatement vom `kind = instance` liefern und im Element `software` den Namen \nund die Versionsnummer angeben.   \nDarüber hinaus MÜSSEN in `CapabilityStatement.instantiates` sämtliche Canonical URLs der implementierten Rollen angegeben werden.\nDie mindestens zu implementierenden Profile für einen Akteur und Interaktionen entsprechen daher den aggregierten Anforderungen der einzelnen Rolle (per 'imports'). In den CapabilityStatements zu den Rollen sind die Anforderungen tabellarisch gelistet und weisen so die zu implementierenden Profile aus.\n\nDas CapabilityStatement der Instanz MUSS alle Funktionalitäten auflisten, die im folgenden CapabilityStatement (bzw. der in ihm importierten Rollen - siehe 'imports') mit `SHALL` gekennzeichnet sind. \nDas CapabilityStatement KANN darüber hinaus die mit `MAY` gekennzeichneten Funktionalitäten, sowie weitere Funktionalitäten auflisten, \nsofern diese in der Instanz implementiert wurden.  \n\nDie Verwendung der CapabilityStatement-Expectation-Extension ist im CapabilityStatement der Server-Instanz nicht erforderlich."
      },
      {
        "extension" : [
      ...
      },
      {
        ...
        "name" : "Example Observation - Herzzeitvolumen",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-herzzeitvolumen"
      },
      {
        "extension" : [
          {
      ...
      },
      {
        ...
        "name" : "Example Observation - ISiKKoerperkerntemperaturExample",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKKoerperkerntemperatur"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - ISiKKoerperkerntemperaturMaxExample",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKKoerperkerntemperatur"
      },
      {
        "extension" : [
        ...
        "name" : "Example Observation - ISiKKoerperkerntemperaturMinExample",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKKoerperkerntemperatur"
      },
      {
        "extension" : [
      ...
      },
      {
        ...
        "name" : "Example Observation - Ideales-Koerpergewicht",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-ideales-koerpergewicht"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Intrakranieller-Druck-ICP",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-intrakranieller-druck-icp"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpergewicht-Percentile-altersabhaengig",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpergewicht-percentil-altersabhaengig"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpergroesse-Percentil",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpergroesse-percentil-altersabhaengig"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Achsel",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-achsel"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Atemwege",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-atemwege"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Blut",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-blut"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Brust",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-brust"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Brustwirbelsaeule",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-brustwirbelsaeule"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Gelenk",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-gelenk"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Halswirbelsaeule",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-halswirbelsaeule"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Harnblase",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-harnblase"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Kern",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-kern"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Leiste",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-leiste"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Lendenwirbelsaeule",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-lendenwirbelsaeule"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Myokard",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-myokard"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Nasen-Rachen-Raum",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-nasen-rachen-raum"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Oral",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-unter-der-zunge"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Speiseroehre",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-speiseroehre"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Stirn",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-stirn"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-Trommelfell",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-trommelfell"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-nasal",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-nasal"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-rektal",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-rektal"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Koerpertemperatur-vaginal",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-vaginal"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Linksatrialer-Druck",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-linksatrialer-druck"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Linksvent-Schlagvolumenindex-Durch-Indikatorverduennung",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-linksventri-schlagvolumenindex-durch-indikatorverd"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Linksventrikulaerer-Druck",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-linksventrikulaerer-druck"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Linksventrikulaerer-Herzindex-Durch-Indikatorverduennung",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-linksventri-herzindex-durch-indikatorverduennung"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Linksventrikulaerer-Herzindex",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-linksventrikulaerer-herzindex"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Linksventrikulaeres-Herzzeitvolumen-durch-Indikatorverduennung",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-linksventri-herzzeitvolumen-durch-indikatorverd"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Linksventrikulaeres-Schlagvolumen-Durch-Indikatorverduennung",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-linksventri-schlagvolumen-durch-indikatorverduennung"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Linksventrikulaeres-Schlagvolumen",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-linksventrikulaeres-schlagvolumen"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Linksventrikulaeres-Schlagvolumenindex",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-linksventrikulaeres-schlagvolumenindex"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Pulmonalarterieller-Blutdruck",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-pulmonalarterieller-blutdruck"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Pulmonalarterieller-wedge-Blutdruck",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-pulmonalarterieller-wedge-druck"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Pulmonalvaskulaerer-Widerstandsindex",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-pulmonalvaskulaerer-widerstandsindex"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Puls",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-puls"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Rechtsatrialer-Druck",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-rechtsatrialer-druck"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Rechtsventrikulaerer-Druck",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-rechtsventrikulaerer-druck"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Sauerstoffsaettigung-im-Arteriellen-Blut-durch-Pulsoxymetrie",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-o2saettigung-im-arteriellen-blut-durch-pulsoxymetrie"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Sauerstoffsaettigung-im-Blut-Postduktal-durch-Pulsoxymetrie",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-o2saettigung-im-blut-postduktal-durch-pulsoxymetrie"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Sauerstoffsaettigung-im-Blut-Preduktal-durch-Pulsoxymetrie",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-o2saettigung-im-blut-preduktal-durch-pulsoxymetrie"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Systemischer-vaskulaerer-Widerstandsindex",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-systemischer-vaskulaerer-widerstandsindex"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example Observation - Zentralvenoeser-Blutdruck",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-zentralvenoeser-blutdruck"
      },
      {
        "extension" : [
          {
      ...
      },
      {
        ...
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKFormularDefinition"
      },
      {
        "extension" : [
          {
      ...
      },
      {
        ...
        "name" : "Example QuestionnaireResponse - ExampleEntryValidationDecimalResponse",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKFormularDaten"
      },
      {
        "extension" : [
          {
        ...
        "name" : "Example QuestionnaireResponse - ExampleExtractWithUnitResponse",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKFormularDaten"
      },
      {
        "extension" : [
        ...
        "name" : "Example QuestionnaireResponse - TestMaxDecimal0",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKFormularDaten"
      },
      {
        "extension" : [
        ...
        "name" : "Example QuestionnaireResponse - TestMaxDecimal1",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKFormularDaten"
      },
      {
        "extension" : [
        ...
        "name" : "Example QuestionnaireResponse - TestMaxDecimal2",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKFormularDaten"
      },
      {
        "extension" : [
        ...
        "name" : "Example QuestionnaireResponse - TestMaxDecimal3",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKFormularDaten"
      },
      {
        "extension" : [
        ...
        "name" : "Example RiskAssessment - ExampleISiKAMTSBewertung1",
        "exampleCanonical" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKAMTSBewertung"
      },
      {
        "extension" : [
          {
      ...
      "page" : [
        ...
        },
        {
          "extension" : [
            {
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "AkteureOhneCpS.html"
            }
          ],
          "nameUrl" : "AkteureOhneCpS.html",
          "title" : "Festlegungen Akteure ohne CapabilityStatement",
          "generation" : "markdown"
        },
        {
          "extension" : [
