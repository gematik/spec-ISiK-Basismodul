...
* **Medication Order (Medikations-Verordnungen):** Informationen über die Verordnung von Medikamenten im Rahmen des medizinischen Workflows - [Capability Statement](CapabilityStatement-ISiKCapabilityStatementMedikationVerordnungAkteur-expanded.md).
* **Administered Medication (Medikations-Verabreichungen):** Informationen über die (erfolgte) Verabreichung bzw. Einnahme von Medikamenten im Rahmen des medizinischen Workflows - [Capability Statement](CapabilityStatement-ISiKCapabilityStatementMedikationVerabreichungAkteur-expanded.md).
