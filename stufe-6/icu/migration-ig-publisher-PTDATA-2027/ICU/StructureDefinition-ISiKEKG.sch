...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile EkgDE
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:component/f:value[x]">
      ...
      <sch:assert test="count(f:dimensions) &gt;= 1">dimensions: minimum cardinality of 'dimensions' is 1</sch:assert>
