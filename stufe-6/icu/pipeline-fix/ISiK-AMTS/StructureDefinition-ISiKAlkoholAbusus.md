# ISiK Alkohol Abusus - AMTS ISiK Implementierungsleitfaden v6.0.0-rc
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/amts|current/StructureDefinition/ISiKAlkoholAbusus)
