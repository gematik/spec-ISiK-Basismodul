# SD MII ICU Linksventrikulaeres Schlagvolumenindex - ISiK ICU v6.0.0-rc
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ICU|current/StructureDefinition/sd-mii-icu-linksventrikulaeres-schlagvolumenindex)
