# ISiK CapabilityStatement Vitalparameter Server Extended (Expanded) - ISiK ICU v6.0.0-rc
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementVitalSignICUSourceExtendedAkteur-expanded | *Version*:6.0.0-rc |
| Active as of 2025-12-17 | *Computable Name*:ISiKCapabilityStatementVitalSignICUSourceExtendedAkteurExpanded |
...
Das vorliegende CapabilityStatement fasst die Rollen (und entsprechende Interaktionen) zusammen, die ein Akteur ‘VitalSign ICU Source Extended’ zur Unterstützung des ICU-Normalstation-Workflows implementieren muss 
