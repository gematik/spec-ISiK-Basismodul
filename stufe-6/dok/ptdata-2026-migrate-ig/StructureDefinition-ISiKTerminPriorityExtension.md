# ISiKTerminPriorityExtension - ISiK Dokumentenaustausch Implementierungsleitfaden v6.0.0-rc
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKTerminPriorityExtension | *Version*:6.0.0-rc |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/dokumentenaustausch|current/StructureDefinition/ISiKTerminPriorityExtension)
