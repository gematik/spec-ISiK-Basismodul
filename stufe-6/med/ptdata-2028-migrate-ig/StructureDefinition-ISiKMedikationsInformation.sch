...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement">
      ...
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKSelbstmedikation']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKSelbstmedikation': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKMedicationStatementReplaces']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKMedicationStatementReplaces': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
