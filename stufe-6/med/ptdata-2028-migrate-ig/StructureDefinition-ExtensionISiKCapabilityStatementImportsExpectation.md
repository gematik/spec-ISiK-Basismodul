# ISiK CapabilityStatement Imports Expectation - ISiK Medikation Implementierungsleitfaden v6.0.0-rc
...
* Examples for this Extension: [ISiKCapabilityStatementMedikationInformationAkteur](CapabilityStatement-ISiKCapabilityStatementMedikationInformationAkteur.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/medikation|current/StructureDefinition/ExtensionISiKCapabilityStatementImportsExpectation)
