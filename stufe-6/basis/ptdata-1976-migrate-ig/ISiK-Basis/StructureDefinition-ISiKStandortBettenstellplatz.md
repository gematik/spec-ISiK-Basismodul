# ISiKStandortBettenstellplatz - ISiK Basis Implementierungsleitfaden v6.0.0-rc
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKStandortBettenstellplatz | *Version*:6.0.0-rc |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/basis|current/StructureDefinition/ISiKStandortBettenstellplatz)
