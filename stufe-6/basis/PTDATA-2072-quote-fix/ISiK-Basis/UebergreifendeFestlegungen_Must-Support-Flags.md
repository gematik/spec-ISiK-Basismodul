# Must-Support-Flags - ISiK Basis Implementierungsleitfaden v6.0.0-rc
...
1. Im Kontext der Erstellung von FHIR-Ressourcen:Elemente, die mit MS gekennzeichnet sind, MÜSSEN vom erstellenden System implementiert werden. Dies bedeutet:
