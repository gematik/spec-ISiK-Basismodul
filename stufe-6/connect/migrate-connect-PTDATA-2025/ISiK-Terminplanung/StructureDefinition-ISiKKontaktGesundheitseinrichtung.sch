...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Encounter/f:account/f:identifier</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:hospitalization/f:dischargeDisposition">
      ...
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKRehaEntlassung']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKRehaEntlassung': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:Encounter/f:location/f:location/f:identifier</sch:title>
