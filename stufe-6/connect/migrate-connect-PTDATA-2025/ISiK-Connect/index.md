# Einführung - ISiK Connect Implementierungsleitfaden v6.0.0-rc
...
| | |
| :--- | :--- |
| *Official URL*:http://example.org/fhir/isik/ImplementationGuide/connect | *Version*:6.0.0-rc |
| Draft as of 2026-02-12 | *Computable Name*:ConnectISiKImplementationGuide |
...
```json
{
  ...
  "id" : "connect",
  "url" : "http://example.org/fhir/isik/ImplementationGuide/connect",
  "version" : "6.0.0-rc",
  "name" : "ConnectISiKImplementationGuide",
  "title" : "ISiK Connect Implementierungsleitfaden",
  "status" : "draft",
  "date" : "2026-02-12T12:59:27+00:00",
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://example.org/fhir/isik/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
