# Umgang mit FHIR-Artefakten - ISiK Basis Implementierungsleitfaden v6.0.0-rc
...
* **Umgang mit FHIR-Artefakten**

## Umgang mit FHIR-Artefakten

Es gelten zur Umsetzung der basalen Funktionalität und weiterer Use Cases in ISiK die Festlegungen zu CapabilityStatements [(Akteure und Rollen)](Erlaeuterung-Akteurs-und-Rollenmodell.md) sowie Datenstrukturen entsprechend der Abschnitte unter [FHIR-Artefakte](artifacts.md).
