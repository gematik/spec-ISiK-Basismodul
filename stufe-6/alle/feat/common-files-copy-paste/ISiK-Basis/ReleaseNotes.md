# Release Notes - ISiK Basis Implementierungsleitfaden v6.0.0-rc
...
* `improve` Auslagern der Subscription Profile und UseCases in ein eigenes Modul Subscription https://github.com/gematik/spec-ISiK-Basismodul/pull/645
...
* `improve` Vereinheitlichung des Umgangs mit ressourcenübergreifenden Suchparametern https://github.com/gematik/spec-ISiK-Basismodul/issues/438
* `fix` Anpassung der include/revinclude Anforderungen in den übergreifenden Festelegungen und dem CapabilityStatement
* `fix` CodeSystem-Ressource wird im CapabilityStatement nun korrekt angezeigt https://github.com/gematik/spec-ISiK-Basismodul/issues/436
