# Example Encounter - FachabteilungskontaktFachbereichswechsel1 - ISiK Vitalparameter Implementierungsleitfaden v6.0.0-rc
...
* **Example Encounter - FachabteilungskontaktFachbereichswechsel1**

## Example Encounter: Example Encounter - FachabteilungskontaktFachbereichswechsel1
...
**period**: 2025-01-01 10:00:00+0100 --> 2025-01-10 08:00:00+0100
...
> **location****location**: Bett B016 (Identifier: `https://test.krankenhaus.de/fhir/sid/bettId`/B016)**status**: Completed**physicalType**: Bed**period**: ?? --> 2025-05-01 12:00:00+0100
