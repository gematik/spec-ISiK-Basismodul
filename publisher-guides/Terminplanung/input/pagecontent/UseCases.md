...
<figure>
    <div class="gem-ig-img-container" style="--box-width: 700px; margin-bottom: 30px;">
        <img src="patient-buchung-UseCase.png" alt="Use Case: Terminbuchung Patient" style="width: 100%;">
    </div>
    <figcaption><strong>Abbildung:</strong>Terminbuchung Patient</figcaption>
</figure>
