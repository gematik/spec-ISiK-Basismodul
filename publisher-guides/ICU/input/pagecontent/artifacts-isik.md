...
Profile aus dem [ISIK Support Modul Labor](https://gemspec.gematik.de/ig/fhir/isik/labor/6.0.0-rc1/index.html) von einem bestätigungsrelevanten System implementiert werden, sofern das System diese Daten verwaltet (z.B. in Form einer Übernahme aus einem Laborinformationssystem).
