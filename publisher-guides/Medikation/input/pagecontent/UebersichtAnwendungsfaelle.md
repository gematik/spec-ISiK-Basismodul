...
Der Use-Case zum Thema Arzneimitteltherapiesicherheit (AMTS) wurde in einem eigenen Implementation Guide ausgelagert. Der Implementation Guide ist über folgenden Link erreichbar: [AMTS Implementierungsleitfaden](https://gemspec.gematik.de/fhir/ig/isik/amts/latest)
