...
Der Use-Case zum Thema Arzneimitteltherapiesicherheit (AMTS) wurde in einen eigenen Implementation Guide ausgelagert. Der Implementation Guides ist über folgenden Link erreichbar: [AMTS Implementierungsleitfaden](https://gemspec.gematik.de/fhir/ig/isik/amts/6.0.0-rc) zu entnehmen.
