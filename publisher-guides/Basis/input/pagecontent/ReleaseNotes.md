...
Datum: tbd
* `improve` Verbesserung der Dokumentation des Suchparameters "characteristic" der Location-Ressource <https://github.com/gematik/spec-ISiK-Basismodul/pull/1233>
