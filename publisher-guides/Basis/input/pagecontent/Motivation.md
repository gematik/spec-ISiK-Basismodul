...
### SMART-on-FHIR-Ökosystem

Darüber hinaus verfolgt ISiK das Ziel, ein interoperables Ökosystem für moderne, webbasierte, leichtgewichtige, modulare Krankenhausanwendungen zu schaffen. Eine wesentliche Motivation hierfür ist die Unterstützung von SMART-on-FHIR-basierten Applikationen. SMART-on-FHIR definiert ein standardisiertes Framework, mit dem Anwendungen sicher und kontextbezogen auf FHIR-Schnittstellen zugreifen können. Dabei werden etablierte Web-Standards wie OAuth2 und OpenID Connect genutzt, um Anwendungen innerhalb bestehender Primärsysteme – beispielsweise Krankenhausinformationssysteme oder klinische Arbeitsplatzsysteme – einzubetten und ihnen kontrollierten Zugriff auf relevante Gesundheitsdaten zu ermöglichen.

Die Intention von SMART-on-FHIR besteht darin, klinische Anwendungen stärker von den zugrundeliegenden Primärsystemen zu entkoppeln. Statt monolithischer, schwer erweiterbarer Gesamtsysteme entsteht dadurch die Möglichkeit eines modularen Anwendungsökosystems, in dem spezialisierte Anwendungen interoperabel zusammenarbeiten können. Krankenhäuser erhalten dadurch mehr Flexibilität bei der Auswahl und Integration neuer Funktionalitäten. Gleichzeitig können Innovationszyklen deutlich verkürzt werden, da neue Anwendungen unabhängig von den Release-Zyklen großer Primärsysteme entwickelt und bereitgestellt werden können.

Die Spezifikationen für Verwendung des SMART-Frameworks im ISiK-Kontext sind im Modul ISiK-Connect beschrieben.
