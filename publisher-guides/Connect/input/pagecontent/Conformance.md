...
* Bestätigungsrelevante ISiK-Ressourcen-Server MÜSSEN über ein '.well-known'-Dokument Informationen über die unterstützen Kontexte und _Scopes_ bereitstellen ([ANF-CON-027](Anforderungsuebersicht.html)).  Für die Details, siehe [Conformance: SMART Capabilities](ConformanceSmartCapabilities.html).

Einzelne oder alle der für die ISiK-Bestätigung umzusetzenden Funktionalitäten KÖNNEN durch einen dem ISiK-Ressourcen-Server vorgelagertes System wie z. B. einen _Reverse Proxy_ oder ein _API Gateway_ realisiert werden ([ANF-CON-028](Anforderungsuebersicht.html)). In diesem Fall ist das vorgeschaltete System aus Sicht von ISiK als Teil des ISiK-Ressourcenservers anzusehen, d. h. bestätigungsrelevant ist die Kombination aus dem vorgeschalteten System und dem die geschützten Ressourcen bereitstellenden System. Entsprechend ist der Begriff "ISiK-Ressourcen-Server" zu interpretieren.
