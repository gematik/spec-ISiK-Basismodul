...
* Bestätigungsrelevante ISiK-Ressourcen-Server MÜSSEN über ein '.well-known'-Dokument Informationen über die unterstützen Kontexte und _Scopes_ bereitstellen ([ANF-CON-027](Anforderungsuebersicht.md)).  Für die Details, siehe [Conformance: SMART Capabilities](ConformanceSmartCapabilities.md).
