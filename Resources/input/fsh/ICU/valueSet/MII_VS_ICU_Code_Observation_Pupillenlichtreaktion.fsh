...
//   * nicht messbar
// - Systeme: http://loinc.org (LA-Antwortcodes) und lokales Zusatz-CodeSystem
// ============================================================
...
Ergaenzt um einen lokalen Code fuer den klinisch relevanten Zustand "nicht messbar".
...
* include $mii-pupil-reaction-additional#not-measurable "nicht messbar"
