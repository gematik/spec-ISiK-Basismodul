...
* code.coding[sct] ^patternCoding.code = #251856003 // "Fluid balance status (observable entity)"
* code.coding[sct].code MS
* code.coding[loinc] 1..1 MS
* code.coding[loinc] ^patternCoding.system = $loinc
* code.coding[loinc] ^patternCoding.code = #9097-7 // "Fluid balance 24 hour"
...
* code.coding[sct] = $sct#251856003 "Fluid balance status"
