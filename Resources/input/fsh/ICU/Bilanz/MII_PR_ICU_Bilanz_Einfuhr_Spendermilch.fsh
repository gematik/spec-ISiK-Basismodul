...
* code.coding[sct] ^patternCoding.code = #819973005 // "Donor breastmilk intake (observable entity)"
...
Instance: BilanzEinfuhrSpendermilchBeispiel
...
* code.coding[sct] = $sct#819973005 "Donor breastmilk intake"
