...
* code.coding[sct] ^patternCoding.code = #251850009 // "Ultrafiltrate fluid loss (observable entity)"
* code.coding[sct].code MS
* code.coding[loinc] 1..1 MS
* code.coding[loinc] ^patternCoding.system = $loinc
* code.coding[loinc] ^patternCoding.code = #99741-1 // "Ultrafiltrate volume removed"
