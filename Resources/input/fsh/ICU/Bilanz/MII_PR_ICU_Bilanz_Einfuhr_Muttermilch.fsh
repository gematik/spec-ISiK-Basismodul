...
* code.coding[sct] ^patternCoding.code = #1204299001 // "Measured volume of intake of breast milk (observable entity)"
...
* code.coding[sct] = $sct#1204299001 "Measured volume of intake of breast milk"
