...
* context.practiceSetting -> "Lookup Composition.encounter.resolve().serviceType" "Mapping per https://wiki.hl7.de/index.php?title=Ihevs:DocumentEntry.PracticeSettingCode von Fachabteilungsschlüssel auf PracticeSetting erforderlich."