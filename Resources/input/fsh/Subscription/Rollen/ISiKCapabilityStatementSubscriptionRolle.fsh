...
// Merge-Topics
// CAVE: Die folgenden SubscriptionTopics müssen hier manuell als unterstützte SubscriptionTopics der Rolle hinzugefügt werden, da hier kein VS eingebunden werden kann.
// Diese Liste und das CodeSystem ISiKSubscriptionTopic müssen manuell synchron gehalten werden.
...
// Ressourcen-Topics
    ...
    * insert AddSubscriptionTopicCanonical("https://gematik.de/fhir/isik/SubscriptionTopic/Resource/Composition")
    ...
    * insert AddSubscriptionTopicCanonical("https://gematik.de/fhir/isik/SubscriptionTopic/Resource/Device")
    * insert AddSubscriptionTopicCanonical("https://gematik.de/fhir/isik/SubscriptionTopic/Resource/DeviceMetric")
    * insert AddSubscriptionTopicCanonical("https://gematik.de/fhir/isik/SubscriptionTopic/Resource/DiagnosticReport")
    ...
    * insert AddSubscriptionTopicCanonical("https://gematik.de/fhir/isik/SubscriptionTopic/Resource/Location")
    ...
    * insert AddSubscriptionTopicCanonical("https://gematik.de/fhir/isik/SubscriptionTopic/Resource/Organization")
