...
* code.coding[SNOMED-CT] = $sct#243142003 "Dual pressure spontaneous ventilation support"
* code.text = "DUO-PAP"
...
* status = #in-progress
* category.coding[SNOMED-CT] = $sct#40617009 "Künstliche Beatmung"
* code.coding[SNOMED-CT] = $sct#1186620002 "Minimum minute volume ventilation"
* code.text = "ASV"
* subject = Reference(ExampleOrganPatientSternenfall)
* performedDateTime = "2020-03-11T20:17:06+01:00"
...
* status = #in-progress
* category.coding[SNOMED-CT] = $sct#40617009 "Künstliche Beatmung"
* code.coding[SNOMED-CT] = $sct#229312009 "Nasal ventilation therapy"
* code.text = "nC"
* subject = Reference(ExampleOrganPatientSternenfall)
* performedDateTime = "2020-03-11T20:17:06+01:00"
...
* status = #in-progress
* category.coding[SNOMED-CT] = $sct#40617009 "Künstliche Beatmung"
* code.coding[SNOMED-CT] = $sct#428311008 "Non-invasive ventilation"
* code.text = "NIV"
* subject = Reference(ExampleOrganPatientSternenfall)
* performedDateTime = "2020-03-11T20:17:06+01:00"
...
* status = #in-progress
* category.coding[SNOMED-CT] = $sct#40617009 "Künstliche Beatmung"
* code.coding[SNOMED-CT] = $sct#1149092001 "Positive pressure ventilation"
* code.text = "PC-Mod"
* subject = Reference(ExampleOrganPatientSternenfall)
* performedDateTime = "2020-03-11T20:17:06+01:00"
...
* status = #in-progress
* category.coding[SNOMED-CT] = $sct#40617009 "Künstliche Beatmung"
* code.coding[SNOMED-CT] = $sct#1186622005 "Synchronized intermittent mandatory ventilation - pressure-control pressure-support inflation"
* code.text = "P-SIMV+"
* subject = Reference(ExampleOrganPatientSternenfall)
* performedDateTime = "2020-03-11T20:17:06+01:00"
...
* status = #in-progress
* category.coding[SNOMED-CT] = $sct#40617009 "Künstliche Beatmung"
* code.coding[SNOMED-CT] = $sct#243141005 "Mechanically assisted spontaneous ventilation"
* code.text = "SPNMod"
* subject = Reference(ExampleOrganPatientSternenfall)
* performedDateTime = "2020-03-11T20:17:06+01:00"
...
* status = #in-progress
* category.coding[SNOMED-CT] = $sct#40617009 "Künstliche Beatmung"
* code.coding[SNOMED-CT] = $sct#47545007 "Kontinuierliche positive Atemwegsdruckbeatmung"
* code.text = "St-Mod"
* subject = Reference(ExampleOrganPatientSternenfall)
* performedDateTime = "2020-03-11T20:17:06+01:00"