...
Alias: $FachabteilungsschluesselErweitertVS = http://fhir.de/ValueSet/dkgev/FachabteilungsschluesselErweitert
...
Alias: $diagnoses-sct = https://gematik.de/fhir/ISiK/v2/ValueSet/diagnoses-sct
