...
Alias: $Aufnahmeanlass-codesystem = http://fhir.de/CodeSystem/dgkev/Aufnahmeanlass
...
Alias: $diagnoses-sct = https://gematik.de/fhir/isik/v1/Basismodul/ValueSet/diagnoses-sct
...
Alias: $Fachabteilungsschluessel-codesystem = http://fhir.de/CodeSystem/dkgev/Fachabteilungsschluessel
...
Alias: $kontaktart-de-codesystem = http://fhir.de/CodeSystem/kontaktart-de
...
Alias: $ops-CodeSystem = http://fhir.de/CodeSystem/bfarm/ops
Alias: $ProzedurDokumentationsdatum = http://fhir.de/StructureDefinition/ProzedurDokumentationsdatum
Alias: $ProzedurenCodes-SCT = https://gematik.de/fhir/isik/v1/Basismodul/ValueSet/ProzedurenCodes-SCT
Alias: $ProzedurenKategorie-SCT = https://gematik.de/fhir/isik/v1/Basismodul/ValueSet/ProzedurenKategorie-SCT
