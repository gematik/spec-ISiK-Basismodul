...
* insert Meta
* obeys isik-pat-1
* . ^constraint[5].source = "https://gematik.de/fhir/ISiK/StructureDefinition/ISiKPatient"
* id 0..1 MS
* identifier MS
...
// extension is working only with ms or cardinality
  ...
  * country 1.. MS
    ...
    * ^constraint[1].source = "https://gematik.de/fhir/ISiK/StructureDefinition/ISiKPatient"
