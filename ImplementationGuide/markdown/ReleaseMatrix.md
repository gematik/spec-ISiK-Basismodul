...
| [ISiK - Vitalparameter und Körpermaße (Release Candidate für Stufe 3)](https://simplifier.net/guide/implementierungsleitfaden-isik-modul-vitalwerte-und-k-rperma-e?version=current) | 1.7.2023 (noch nicht festgelegt)   |        3.0.0-rc1     |    11.04.2023    |   noch nicht festgelegt |    noch nicht festgelegt | -      | [ISiK - Basis (Stufe 2)](https://simplifier.net/isik)  |
