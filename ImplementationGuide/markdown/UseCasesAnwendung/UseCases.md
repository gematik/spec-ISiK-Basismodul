...
* **Beispiel für einen Include Zusammenhang:** Eine Applikation muss in der Lage sein ein _ISiK Diagnose_ anhand des Falls in Form von _Encounter_ suchen zu können, um den (Adverse) Use Case einer _Verwechslung_ zu vermeiden.
