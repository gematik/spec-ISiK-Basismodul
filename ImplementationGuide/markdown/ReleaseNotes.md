...
Eine Gesamtübersicht zu den Releases der ISiK Module ist über die [Release-Tabelle](https://github.com/gematik/spec-ISiK-Releasematrix/blob/main/ReleaseMatrix.md) einsehbar.
