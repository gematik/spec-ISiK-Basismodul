# ISiKMedikationsInformation - ISiK Medikation Implementierungsleitfaden v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKMedikationsInformation | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKMedikationsInformation |
...
* CapabilityStatements using this Profile: [ISiK CapabilityStatement Medikationsinformation Server Akteur (Expanded)](CapabilityStatement-ISiKCapabilityStatementMedikationInformationAkteur-expanded.md), [ISiK CapabilityStatement Medikation Server - Medikationsinformation](CapabilityStatement-ISiKCapabilityStatementMedikationInformationRolle.md) and [ISiK CapabilityStatement Medikationsinformation WRITE Rolle](CapabilityStatement-ISiKCapabilityStatementMedikationInformationWRITERolle.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/medikation|current/StructureDefinition/StructureDefinition-ISiKMedikationsInformation.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKAcceptedRisk"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKMedikationsart"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKSelbstmedikation"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKBehandlungsziel"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "severity" : "error",
        "human" : "Wenn Indikationen für eine Bedarfsmedikation angegeben sind, MUSS asNeededBoolean vorhanden und true sein.",
        ...
        "source" : "https://gematik.de/fhir/isik/StructureDefinition/ISiKMedikationsInformation"
      }],
      "mustSupport" : true
    },
    {
    ...
    {
      "id" : "MedicationStatement.dosage.extension.extension",
      "path" : "MedicationStatement.dosage.extension.extension",
      "max" : "0"
    },
    {
      "id" : "MedicationStatement.dosage.extension.value[x]",
    ...
    {
      "id" : "MedicationStatement.dosage.extension.value[x]:valueCodeableConcept",
      "path" : "MedicationStatement.dosage.extension.value[x]",
    ...
    {
      "id" : "MedicationStatement.dosage.extension.value[x]:valueCodeableConcept.text",
      "path" : "MedicationStatement.dosage.extension.value[x].text",
    ...
    {
      "id" : "MedicationStatement.dosage.extension:asNeededFor",
      "path" : "MedicationStatement.dosage.extension",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Quantity",
        "profile" : ["https://gematik.de/fhir/isik/StructureDefinition/MedicationQuantityDoseForm"]
      }],
      "mustSupport" : true
    },
    {
