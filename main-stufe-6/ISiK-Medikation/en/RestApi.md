# REST-API - ISiK Medikation Implementierungsleitfaden v6.0.0
...
Es gelten grundsätzlich die [Allgemeinen Hinweise zur REST API aus dem Basismodul](https://gemspec.gematik.de/ig/fhir/isik/basis/6.0.0-rc1/UebergreifendeFestlegungen_Rest.html).
