# ISiK CapabilityStatement Medikationsinformation Server Akteur (Expanded) - ISiK Medikation Implementierungsleitfaden v6.0.0
...
* **ISiK CapabilityStatement Medikationsinformation Server Akteur (Expanded)**

## CapabilityStatement: ISiK CapabilityStatement Medikationsinformation Server Akteur (Expanded) 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementMedikationInformationAkteur-expanded | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKCapabilityStatementMedikationInformationAkteurExpanded |
...
```json
{
  ...
  "id" : "ISiKCapabilityStatementMedikationInformationAkteur-expanded",
  "url" : "https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementMedikationInformationAkteur-expanded",
  "version" : "6.0.0",
  "name" : "ISiKCapabilityStatementMedikationInformationAkteurExpanded",
  "title" : "ISiK CapabilityStatement Medikationsinformation Server Akteur (Expanded)",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-07-01",
