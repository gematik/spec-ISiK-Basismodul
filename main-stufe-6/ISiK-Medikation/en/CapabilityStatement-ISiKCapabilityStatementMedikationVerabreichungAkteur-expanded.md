# ISiK CapabilityStatement Medikationsverabreichung Server Akteur (Expanded) - ISiK Medikation Implementierungsleitfaden v6.0.0
...
* **ISiK CapabilityStatement Medikationsverabreichung Server Akteur (Expanded)**

## CapabilityStatement: ISiK CapabilityStatement Medikationsverabreichung Server Akteur (Expanded) 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementMedikationVerabreichungAkteur-expanded | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKCapabilityStatementMedikationVerabreichungMedikationsinformationAkteurExpanded |
...
```json
{
  ...
  "id" : "ISiKCapabilityStatementMedikationVerabreichungAkteur-expanded",
  "url" : "https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementMedikationVerabreichungAkteur-expanded",
  "version" : "6.0.0",
  "name" : "ISiKCapabilityStatementMedikationVerabreichungMedikationsinformationAkteurExpanded",
  "title" : "ISiK CapabilityStatement Medikationsverabreichung Server Akteur (Expanded)",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-07-01",
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "searchInclude" : ["MedicationAdministration:medication",
