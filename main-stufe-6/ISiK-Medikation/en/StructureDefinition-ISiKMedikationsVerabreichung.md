# ISiKMedikationsVerabreichung - ISiK Medikation Implementierungsleitfaden v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKMedikationsVerabreichung | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKMedikationsVerabreichung |
...
* CapabilityStatements using this Profile: [ISiK CapabilityStatement Medikationsverabreichung Server Akteur (Expanded)](CapabilityStatement-ISiKCapabilityStatementMedikationVerabreichungAkteur-expanded.md), [ISiK CapabilityStatement Medikationsverabreichung Rolle](CapabilityStatement-ISiKCapabilityStatementMedikationVerabreichungRolle.md) and [ISiK CapabilityStatement Medikationsverabreichung WRITE Rolle](CapabilityStatement-ISiKCapabilityStatementMedikationVerabreichungWRITERolle.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/medikation|current/StructureDefinition/StructureDefinition-ISiKMedikationsVerabreichung.json)
