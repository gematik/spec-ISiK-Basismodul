# ExampleISiKMedikationsVerordnung - ISiK Medikation Implementierungsleitfaden v6.0.0
...
## MedicationRequest: ExampleISiKMedikationsVerordnung
...
**reasonReference**: [Condition/BehandlungsDiagnoseFreitext](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.org/packages/de.basisprofil.r4/Condition/BehandlungsDiagnoseFreitext)
