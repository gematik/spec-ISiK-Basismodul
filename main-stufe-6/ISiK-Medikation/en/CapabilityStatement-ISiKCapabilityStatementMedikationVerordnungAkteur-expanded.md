# ISiK CapabilityStatement Medikationsverordnung Server Akteur (Expanded) - ISiK Medikation Implementierungsleitfaden v6.0.0
...
* **ISiK CapabilityStatement Medikationsverordnung Server Akteur (Expanded)**

## CapabilityStatement: ISiK CapabilityStatement Medikationsverordnung Server Akteur (Expanded) 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementMedikationVerordnungAkteur-expanded | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKCapabilityStatementMedikationVerordnungAkteurExpanded |
...
```json
{
  ...
  "id" : "ISiKCapabilityStatementMedikationVerordnungAkteur-expanded",
  "url" : "https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementMedikationVerordnungAkteur-expanded",
  "version" : "6.0.0",
  "name" : "ISiKCapabilityStatementMedikationVerordnungAkteurExpanded",
  "title" : "ISiK CapabilityStatement Medikationsverordnung Server Akteur (Expanded)",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-07-01",
