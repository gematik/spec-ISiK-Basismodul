# Akteur `ISiKCapabilityStatementFormularVorbelegungAkteur` (Expanded) - ISiK Formularmodul Implementation Guide v6.0.0
...
* **Akteur `ISiKCapabilityStatementFormularVorbelegungAkteur` (Expanded)**

## CapabilityStatement: Akteur `ISiKCapabilityStatementFormularVorbelegungAkteur` (Expanded) 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementFormularVorbelegungAkteur-expanded | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiK-CapabilityStatementFormularVorbelegungAkteurExpanded |
...
```json
{
  ...
  "id" : "ISiKCapabilityStatementFormularVorbelegungAkteur-expanded",
  "url" : "https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementFormularVorbelegungAkteur-expanded",
  "version" : "6.0.0",
  "name" : "ISiK-CapabilityStatementFormularVorbelegungAkteurExpanded",
  "title" : "Akteur `ISiKCapabilityStatementFormularVorbelegungAkteur` (Expanded)",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-07-01",
