# Best Practice für FormularDefinitionen - ISiK Formularmodul Implementation Guide v6.0.0
...
FormularDefinitionen sollten sich auf den Umfang der in diesem Modul festgelegten Funktionalitäten und Extensions beschränken. Alle weiteren Funtionalitäten und Extensions müssen so verwendet werden, dass diese von einem [FormularRenderer](Akteure.md#formularrenderer) gefahrlos ignoriert werden können, ohne dass dies die Nutzbarkeit des Formulars einschränkt.
