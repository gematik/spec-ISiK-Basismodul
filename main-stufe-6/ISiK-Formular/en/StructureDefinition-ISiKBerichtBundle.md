# ISiKBerichtBundle - ISiK Formularmodul Implementation Guide v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKBerichtBundle | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKBerichtBundle |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/formular|current/StructureDefinition/StructureDefinition-ISiKBerichtBundle.json)
