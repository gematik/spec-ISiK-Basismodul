# ISiKBerichtSubSysteme - ISiK Formularmodul Implementation Guide v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKBerichtSubSysteme | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKBerichtSubSysteme |
...
* Examples for this Profile: [Composition/CompositionExampleBlutdruck](Composition-CompositionExampleBlutdruck.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/formular|current/StructureDefinition/StructureDefinition-ISiKBerichtSubSysteme.json)
