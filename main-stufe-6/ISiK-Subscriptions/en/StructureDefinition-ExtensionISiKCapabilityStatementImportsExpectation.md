# ISiK CapabilityStatement Imports Expectation - ISiK Subscription Implementierungsleitfaden v6.0.0
...
* Examples for this Extension: [ISiK-CapabilityStatementSubscriptionServerAkteur](CapabilityStatement-ISiKCapabilityStatementSubscriptionServerAkteur.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/subscription|current/StructureDefinition/StructureDefinition-ExtensionISiKCapabilityStatementImportsExpectation.json)
