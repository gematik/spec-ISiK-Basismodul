# Resource ISiK Subscription Implementierungsleitfaden
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-09-17T12:18:57+00:00",
  ...
  "definition" : {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementSubscriptionServerAkteur.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementSubscriptionServerAkteur-expanded.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementSubscriptionRolle.html"
      }],
      "reference" : {
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "Kontaktzusammenfuehrung.html"
        }],
        "nameUrl" : "Kontaktzusammenfuehrung.html",
        "title" : "Encounter Merge Notification (Kontaktzusammenführung)",
        "generation" : "markdown"
      },
      {
        "extension" : [{
