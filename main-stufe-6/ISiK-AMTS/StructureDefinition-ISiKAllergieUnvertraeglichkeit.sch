...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:extension/f:value[x] 1</sch:title>
    <sch:rule context="f:AllergyIntolerance/f:extension/f:value[x]">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.de/StructureDefinition/lebensphase']) &lt;= 1">extension with URL = 'http://fhir.de/StructureDefinition/lebensphase': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:clinicalStatus/f:coding</sch:title>
    <sch:rule context="f:AllergyIntolerance/f:clinicalStatus/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:encounter</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:AllergyIntolerance/f:note/f:author[x] 1</sch:title>
