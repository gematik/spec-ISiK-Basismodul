# ISiKMedikationsVerabreichung - AMTS ISiK Implementierungsleitfaden v6.0.0
...
* CapabilityStatements using this Profile: [ISiK CapabilityStatement AMTS Akteur (Expanded)](CapabilityStatement-ISiKCapabilityStatementAMTSAkteur-expanded.md), [ISiK CapabilityStatement Medikationsverabreichung Rolle](CapabilityStatement-ISiKCapabilityStatementMedikationVerabreichungRolle.md) and [ISiK CapabilityStatement Medikationsverabreichung WRITE Rolle](CapabilityStatement-ISiKCapabilityStatementMedikationVerabreichungWRITERolle.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/amts|current/StructureDefinition/StructureDefinition-ISiKMedikationsVerabreichung.json)
