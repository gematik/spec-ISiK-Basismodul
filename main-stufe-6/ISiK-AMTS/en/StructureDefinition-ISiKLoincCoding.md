# ISiKLoincCoding - AMTS ISiK Implementierungsleitfaden v6.0.0
...
* Use this DataType Profile: [ISiKKoerpergewicht](StructureDefinition-ISiKKoerpergewicht.md), [ISiKKoerpergroesse](StructureDefinition-ISiKKoerpergroesse.md), [ISiKLaboruntersuchung](StructureDefinition-ISiKLaboruntersuchung.md) and [ISiKLebensZustand](StructureDefinition-ISiKLebensZustand.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/amts|current/StructureDefinition/StructureDefinition-ISiKLoincCoding.json)
