# ISiKLoincCoding - ISiK Labor Implementierungsleitfaden v6.0.0
...
* Use this DataType Profile: [ISiKLaboruntersuchung](StructureDefinition-ISiKLaboruntersuchung.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/labor|current/StructureDefinition/StructureDefinition-ISiKLoincCoding.json)
