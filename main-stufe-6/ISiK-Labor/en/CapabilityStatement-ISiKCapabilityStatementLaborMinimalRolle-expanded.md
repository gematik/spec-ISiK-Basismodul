# ISiK CapabilityStatement Labor Minimal Rolle (Expanded) - ISiK Labor Implementierungsleitfaden v6.0.0
...
* **ISiK CapabilityStatement Labor Minimal Rolle (Expanded)**

## CapabilityStatement: ISiK CapabilityStatement Labor Minimal Rolle (Expanded) 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementLaborMinimalRolle-expanded | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKCapabilityStatementLaborMinimalRolleExpanded |
...
```json
{
  ...
  "id" : "ISiKCapabilityStatementLaborMinimalRolle-expanded",
  "url" : "https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementLaborMinimalRolle-expanded",
  "version" : "6.0.0",
  "name" : "ISiKCapabilityStatementLaborMinimalRolleExpanded",
  "title" : "ISiK CapabilityStatement Labor Minimal Rolle (Expanded)",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-07-01",
