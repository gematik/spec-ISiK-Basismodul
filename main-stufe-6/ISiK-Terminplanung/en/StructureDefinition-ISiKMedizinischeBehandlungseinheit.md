# ISiKMedizinischeBehandlungseinheit - ISiK Terminplanung Implementierungsleitfaden v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKMedizinischeBehandlungseinheit | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKMedizinischeBehandlungseinheit |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/terminplanung|current/StructureDefinition/StructureDefinition-ISiKMedizinischeBehandlungseinheit.json)
