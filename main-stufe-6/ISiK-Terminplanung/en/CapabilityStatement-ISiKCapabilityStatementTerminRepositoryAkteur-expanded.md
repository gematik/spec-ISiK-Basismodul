# ISiK CapabilityStatement Termin-Repository Akteur (Expanded) - ISiK Terminplanung Implementierungsleitfaden v6.0.0
...
* **ISiK CapabilityStatement Termin-Repository Akteur (Expanded)**

## CapabilityStatement: ISiK CapabilityStatement Termin-Repository Akteur (Expanded) 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementTerminRepositoryAkteur-expanded | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKCapabilityStatementTerminRepositoryAkteurExpanded |
...
```json
{
  ...
  "id" : "ISiKCapabilityStatementTerminRepositoryAkteur-expanded",
  "url" : "https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementTerminRepositoryAkteur-expanded",
  "version" : "6.0.0",
  "name" : "ISiKCapabilityStatementTerminRepositoryAkteurExpanded",
  "title" : "ISiK CapabilityStatement Termin-Repository Akteur (Expanded)",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-07-01",
  ...
  "rest" : [{
    ...
    },
    {
      ...
      "type" : "Subscription",
      "supportedProfile" : ["https://gematik.de/fhir/isik/StructureDefinition/ISiKSubscriptionTermin"],
      "interaction" : [{
        "extension" : [{
          "url" : "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation",
          "valueCode" : "SHALL"
