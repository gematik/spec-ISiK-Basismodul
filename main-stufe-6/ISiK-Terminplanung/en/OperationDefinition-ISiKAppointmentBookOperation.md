# Book - ISiK Terminplanung Implementierungsleitfaden v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/OperationDefinition/AppointmentBook | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:Book |
...
```json
{
  ...
  },
  {
    ...
    "type" : "Reference",
    "targetProfile" : ["https://gematik.de/fhir/isik/StructureDefinition/ISiKKalender"]
  },
  {
    "name" : "patient",
    "use" : "in",
