# CapabilityStatement für Rolle Termin Subscription - ISiK Terminplanung Implementierungsleitfaden v6.0.0
...
* **CapabilityStatement für Rolle Termin Subscription**

## CapabilityStatement: CapabilityStatement für Rolle Termin Subscription 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementTerminSubscriptionRolle | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKCapabilityStatementTerminSubscriptionRolle |
...
```json
{
  ...
  "id" : "ISiKCapabilityStatementTerminSubscriptionRolle",
  ...
  "purpose" : "\nCapabilityStatement für die Rolle &quot;ISiKCapabilityStatementTerminSubscriptionRolle&quot;.\nDiese Rolle beschreibt die Fähigkeiten eines Systems zur Registrierung, Verwaltung und Verarbeitung von FHIR Subscriptions auf Basis themenbasierter Benachrichtigungen, aus dem Kontext der Terminplanung, nach dem R5-Modell unter Verwendung der Subscriptions-Backport-Mechanismen in FHIR R4.\n",
  "kind" : "requirements",
  "fhirVersion" : "4.0.1",
