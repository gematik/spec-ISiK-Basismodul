# ExampleOrganVentilationModeNIV - ISiK Organspendeerkennung v6.0.0
...
* **ExampleOrganVentilationModeNIV**

## Procedure: ExampleOrganVentilationModeNIV
...
```json
{
  ...
  "id" : "ExampleOrganVentilationModeNIV",
  "meta" : {
