# ExampleOrganVentilationModeBiLev - ISiK Organspendeerkennung v6.0.0
...
* **ExampleOrganVentilationModeBiLev**

## Procedure: ExampleOrganVentilationModeBiLev
...
```json
{
  ...
  "id" : "ExampleOrganVentilationModeBiLev",
  "meta" : {
