# ISiKProzedur - ISiK Organspendeerkennung v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKProzedur | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKProzedur |
...
* Derived from this Profile: [ISiK Prozedur Beatmung](StructureDefinition-ISiKProzedurBeatmung.md) and [ISiK Prozedur Reanimation](StructureDefinition-ISiKProzedurReanimation.md)
* Examples for this Profile: [Procedure/Appendektomie](Procedure-Appendektomie.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/organspendeerkennung|current/StructureDefinition/StructureDefinition-ISiKProzedur.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://fhir.de/StructureDefinition/ProzedurDokumentationsdatum"]
      }],
      "mustSupport" : true
    },
    {
    ...
    {
      "id" : "Procedure.bodySite.extension:BodyStructureReference",
