# ISiK CapabilityStatement Imports Expectation - ISiK Organspendeerkennung v6.0.0
...
* Examples for this Extension: [ISiKCapabilityStatementOrganspendeerkennungSourceAkteur](CapabilityStatement-ISiKCapabilityStatementOrganspendeerkennungSourceAkteur.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/organspendeerkennung|current/StructureDefinition/StructureDefinition-ExtensionISiKCapabilityStatementImportsExpectation.json)
