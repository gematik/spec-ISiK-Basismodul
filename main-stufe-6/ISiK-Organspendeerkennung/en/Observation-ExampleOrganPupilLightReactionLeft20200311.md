# ExampleOrganPupilLightReactionLeft20200311 - ISiK Organspendeerkennung v6.0.0
...
* **ExampleOrganPupilLightReactionLeft20200311**

## Observation: ExampleOrganPupilLightReactionLeft20200311
...
Quelle: left pupil reaction = nicht messbar
...
```json
{
  ...
  "id" : "ExampleOrganPupilLightReactionLeft20200311",
  "meta" : {
  ...
  "note" : [{
    "text" : "Quelle: left pupil reaction = nicht messbar"
  }],
  "bodySite" : {
    "coding" : [{
      "system" : "http://snomed.info/sct",
