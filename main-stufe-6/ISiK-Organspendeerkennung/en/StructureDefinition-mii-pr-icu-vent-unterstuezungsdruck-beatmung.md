# MII PR ICU Unterstuezungsdruck Beatmung - ISiK Organspendeerkennung v6.0.0
...
## Resource Profile: MII PR ICU Unterstuezungsdruck Beatmung 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-vent-unterstuezungsdruck-beatmung | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:MII_PR_ICU_Unterstuezungsdruck_Beatmung |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/organspendeerkennung|current/StructureDefinition/StructureDefinition-mii-pr-icu-vent-unterstuezungsdruck-beatmung.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-vent-unterstuezungsdruck-beatmung.csv), [Excel](../StructureDefinition-mii-pr-icu-vent-unterstuezungsdruck-beatmung.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-vent-unterstuezungsdruck-beatmung.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-vent-unterstuezungsdruck-beatmung",
  "version" : "6.0.0",
  "name" : "MII_PR_ICU_Unterstuezungsdruck_Beatmung",
