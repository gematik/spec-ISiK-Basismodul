# MII VS ICU Code Procedure Beatmung SNOMED - ISiK Organspendeerkennung v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/ValueSet/mii-vs-icu-code-procedure-beatmung-snomed | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:MII_VS_ICU_Code_Procedure_Beatmung_SNOMED |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/isik/ValueSet/mii-vs-icu-code-procedure-beatmung-snomed",
  "version" : "6.0.0",
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "47545007",
        "display" : "Kontinuierliche positive Atemwegsdruckbeatmung"
      },
      {
        "code" : "243142003",
        "display" : "Dual pressure spontaneous ventilation support"
      },
      {
        "code" : "37113006",
      ...
      {
        "code" : "1186622005",
        "display" : "Synchronized intermittent mandatory ventilation - pressure-control pressure-support inflation"
      },
      {
        "code" : "1259864003",
