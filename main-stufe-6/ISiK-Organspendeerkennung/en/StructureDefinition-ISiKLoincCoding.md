# ISiKLoincCoding - ISiK Organspendeerkennung v6.0.0
...
* Use this DataType Profile: [ISiKGCS](StructureDefinition-ISiKGCS.md) and [ISiKLaboruntersuchung](StructureDefinition-ISiKLaboruntersuchung.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/organspendeerkennung|current/StructureDefinition/StructureDefinition-ISiKLoincCoding.json)
