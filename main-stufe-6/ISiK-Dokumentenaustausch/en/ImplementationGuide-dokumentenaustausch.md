# Resource ISiK Dokumentenaustausch Implementierungsleitfaden
...
```json
{
  ...
  "id" : "dokumentenaustausch",
  "language" : "en",
  "url" : "https://gematik.de/fhir/isik/ImplementationGuide/dokumentenaustausch",
  "version" : "6.0.0",
  "name" : "ISiKDokumentenaustauschImplementationGuide",
  "title" : "ISiK Dokumentenaustausch Implementierungsleitfaden",
  "status" : "active",
  "date" : "2026-09-17T12:16:35+00:00",
  ...
  "description" : "Dieser Implementierungsleitfaden spezifiziert eine ISiK-konforme Umsetzung des Dokumentenaustauschs im Krankenhaus.",
  "packageId" : "dokumentenaustausch",
  "license" : "Apache-2.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "DocumentReference-dok-beispiel-client-with-binary-jpeg-example.html"
      }],
      "reference" : {
        "reference" : "DocumentReference/dok-beispiel-client-with-binary-jpeg-example"
      },
      "name" : "dok-beispiel-client-with-binary-jpeg-example",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "DocumentReference-dok-beispiel-client-with-binary-jpeg-example-short.html"
      }],
      "reference" : {
        "reference" : "DocumentReference/dok-beispiel-client-with-binary-jpeg-example-short"
      },
      "name" : "dok-beispiel-client-with-binary-jpeg-example-short",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "DocumentReference-dok-beispiel-client-with-binary-pdf-example.html"
      }],
      "reference" : {
        "reference" : "DocumentReference/dok-beispiel-client-with-binary-pdf-example"
      },
      "name" : "dok-beispiel-client-with-binary-pdf-example",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "DocumentReference-dok-beispiel-client-with-binary-pdf-example-short.html"
      }],
      "reference" : {
        "reference" : "DocumentReference/dok-beispiel-client-with-binary-pdf-example-short"
      },
      "name" : "dok-beispiel-client-with-binary-pdf-example-short",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "DocumentReference-dok-beispiel-server.html"
      }],
      "reference" : {
        "reference" : "DocumentReference/dok-beispiel-server"
      },
      "name" : "dok-beispiel-server",
      "exampleBoolean" : false
    },
    {
      "extension" : [{
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-ISiKDokumentenMetadaten.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementDokumentenServerAkteur.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementDokumentenServerAkteur-expanded.html"
      }],
      "reference" : {
        "reference" : "CapabilityStatement/ISiKCapabilityStatementDokumentenServerAkteur-expanded"
      },
      "name" : "ISiK CapabilityStatement Dokumenten Server Akteur (Expanded)",
      "description" : "Dieses CapabilityStatement beschreibt alle Interaktionen, \n  die ein System unterstützen MUSS, welches diesen Akteur implementiert.   \n\n  Jede Instanz eines bestätigungsrelevanten Systems MUSS an ihrem Endpunkt eine CapabilityStatement-Ressource bereitstellen.\nHierzu MUSS die [capabilities-Interaktion gemäß FHIR-Kernspezifikation](https://hl7.org/fhir/R4/http.html#capabilities) unterstützt werden. \nDer `MODE`-Parameter kann ignoriert werden.  \nDas CapabilityStatement in dieser Spezifikation stellt die Anforderungen seitens der gematik dar (`kind = requirements`).\nZur Unterscheidung von Rollen, die erfüllt werden MÜSSEN gegenüber jenen, die erfüllt werden KÖNNEN,\nwird die [CapabilityStatement-Imports-Expectation-Extension](https://gematik.de/fhir/isik/StructureDefinition/ExtensionISiKCapabilityStatementImportsExpectation) verwendet (siehe [Verbindlichkeit in CapabilityStatements](https://gemspec.gematik.de/ig/fhir/isik/basis/6.0.0/UebergreifendeFestlegungen_Methodik.html) für die verwendeten Codes).\n\nEine Server-Instanz MUSS ihrerseits ein CapabilityStatement vom `kind = instance` liefern und im Element `software` den Namen \nund die Versionsnummer angeben.   \nDarüber hinaus MÜSSEN in `CapabilityStatement.instantiates` sämtliche Canonical URLs der implementierten Rollen angegeben werden.\nDie mindestens zu implementierenden Profile für einen Akteur und Interaktionen entsprechen daher den aggregierten Anforderungen der einzelnen Rolle (per 'imports'). In den CapabilityStatements zu den Rollen sind die Anforderungen tabellarisch gelistet und weisen so die zu implementierenden Profile aus.\n\nDas CapabilityStatement der Instanz MUSS alle Funktionalitäten auflisten, die im folgenden CapabilityStatement (bzw. der in ihm importierten Rollen - siehe 'imports') mit `SHALL` gekennzeichnet sind. \nDas CapabilityStatement KANN darüber hinaus die mit `MAY` gekennzeichneten Funktionalitäten, sowie weitere Funktionalitäten auflisten, \nsofern diese in der Instanz implementiert wurden.  \n\nDie Verwendung der CapabilityStatement-Expectation-Extension ist im CapabilityStatement der Server-Instanz nicht erforderlich.",
      "exampleBoolean" : false
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementDokumentenverwaltungRolle.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementMetadatenErzeugenRolle.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementMetadatenUpdateRolle.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-ISiKBinary.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-ISiKConfidentialityCodes.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "OperationDefinition-UpdateMetadata.html"
      }],
      "reference" : {
    ...
    "page" : {
      ...
      },
      {
        ...
        "title" : "Kompatibilität zu IHE-Profilen",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "Abgrenzung-Basis.html"
        }],
        "nameUrl" : "Abgrenzung-Basis.html",
        "title" : "Abgrenzung zu ISiK Basis bei Kommunikation strukturierter Daten",
        "generation" : "markdown"
      },
      {
        "extension" : [{
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "Interaktion-Dokumentenbereitstellung.html"
        }],
        "nameUrl" : "Interaktion-Dokumentenbereitstellung.html",
        "title" : "Interaktion: Dokumentenbereitstellung",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "Dokumentenabfrage.html"
        }],
        "nameUrl" : "Dokumentenabfrage.html",
        "title" : "Interaktion: Dokumentenabfrage und -Zugriff",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "Update.html"
        }],
        "nameUrl" : "Update.html",
        "title" : "Interaktion: Update von Metadaten",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "ErzeugenVonMetadaten.html"
        }],
        "nameUrl" : "ErzeugenVonMetadaten.html",
        "title" : "Interaktion: Erzeugen von Metadaten",
        "generation" : "markdown"
      },
      {
        "extension" : [{
