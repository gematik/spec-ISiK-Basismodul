# Erforderliche Metadaten für Dokumentenaustausch in ISiK - ISiK Dokumentenaustausch Implementierungsleitfaden v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKDokumentenMetadaten | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKDokumentenMetadaten |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dokumentenaustausch|current/StructureDefinition/StructureDefinition-ISiKDokumentenMetadaten.json)
