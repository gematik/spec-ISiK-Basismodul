# ISiK CapabilityStatement Dokumenten Server Akteur (Expanded) - ISiK Dokumentenaustausch Implementierungsleitfaden v6.0.0
...
## CapabilityStatement: ISiK CapabilityStatement Dokumenten Server Akteur (Expanded) 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementDokumentenServerAkteur-expanded | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKCapabilityStatementDokumentenServerAkteurExpanded |
...
```json
{
  ...
  "id" : "ISiKCapabilityStatementDokumentenServerAkteur-expanded",
  "url" : "https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementDokumentenServerAkteur-expanded",
  "version" : "6.0.0",
  "name" : "ISiKCapabilityStatementDokumentenServerAkteurExpanded",
  "title" : "ISiK CapabilityStatement Dokumenten Server Akteur (Expanded)",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-07-01",
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "searchInclude" : ["DocumentReference:patient", "DocumentReference:encounter"],
      "_searchInclude" : [{
        "extension" : [{
          "url" : "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation",
          "valueCode" : "SHALL"
