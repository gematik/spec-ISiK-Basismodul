# FachabteilungskontaktNormal - ISiK Dokumentenaustausch Implementierungsleitfaden v6.0.0
...
* ErsteUndZweiteStelle: [CodeSystemAufnahmegrundErsteUndZweiteStelle: 01](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.de/CodeSystem/dkgev/AufnahmegrundErsteUndZweiteStelle#AufnahmegrundErsteUndZweiteStelle-01) (Krankenhausbehandlung, vollstationär)

**R5: The planned start date/time (or admission date) of the encounter (new)**: 2025-01-02

**R5: The planned end date/time (or discharge date) of the encounter (new)**: 2025-01-04
...
| :--- | :--- | :--- | :--- |
| - | **Condition** | **Use** | **Rank** |
| * | [Condition/PrimaereGonarthroseNormal](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.org/packages/de.basisprofil.r4/Condition/PrimaereGonarthroseNormal) | Behandlungsrelevante Diagnosen | 1 |

**account**: [Account/AbrechnungsfallGonarthrose](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.org/packages/de.basisprofil.r4/Account/AbrechnungsfallGonarthrose)
...
> **location****location**: [Zimmer 1234](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.org/packages/de.basisprofil.r4/Location/RaumStandortBeispiel)**status**: Active**physicalType**: Room

> **location****location**: [Bettenstellplatz 1234](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.org/packages/de.basisprofil.r4/Location/BettenstellplatzStandortBeispiel)**status**: Active**physicalType**: Bed
