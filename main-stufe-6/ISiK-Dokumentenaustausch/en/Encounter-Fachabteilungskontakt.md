# Fachabteilungskontakt - ISiK Dokumentenaustausch Implementierungsleitfaden v6.0.0
...
## Encounter: Fachabteilungskontakt
...
* DritteStelle: [AufnahmegrundDritteStelle: 0](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.de/CodeSystem/dkgev/AufnahmegrundDritteStelle#AufnahmegrundDritteStelle-0) (Anderes)
* VierteStelle: [AufnahmegrundVierteStelle: 1](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.de/CodeSystem/dkgev/AufnahmegrundVierteStelle#AufnahmegrundVierteStelle-1) (Normalfall)
...
| :--- | :--- | :--- |
| - | **Condition** | **Use** |
| * | [Condition/BehandlungsDiagnoseFreitext](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.org/packages/de.basisprofil.r4/Condition/BehandlungsDiagnoseFreitext) | Behandlungsrelevante Diagnosen |

**account**: [Account/AbrechnungsfallDRG](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.org/packages/de.basisprofil.r4/Account/AbrechnungsfallDRG)
