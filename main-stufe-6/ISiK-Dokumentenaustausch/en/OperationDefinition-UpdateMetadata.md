# Update document metadata - ISiK Dokumentenaustausch Implementierungsleitfaden v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/OperationDefinition/UpdateMetadata | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:UpdateMetadata |
...
Der Client muss zunächst die URL der DocumentReference ermitteln, auf die das Update angewendet werden soll. Hierzu kann die Interaktion [Dokumentenabfrage](Dokumentenabfrage.md) verwendet werden. 
**Metadatenupdate** 
