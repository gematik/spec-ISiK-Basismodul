# Performance - ISiK Basis Implementierungsleitfaden v6.0.0
...
1. Vermeidung unnötiger Wiederholungsabfragen
...
1. Caching und bedingte Aktualisierung (ETag/If-None-Match)
...
1. Aktualisierungsstrategie für Live-Betrieb
