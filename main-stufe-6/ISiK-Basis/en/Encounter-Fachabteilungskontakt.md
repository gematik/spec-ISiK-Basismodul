# Fachabteilungskontakt - ISiK Basis Implementierungsleitfaden v6.0.0
...
**account**: [Account: extension = ; identifier = Account number; status = active](Account-AbrechnungsfallDRG.md)
