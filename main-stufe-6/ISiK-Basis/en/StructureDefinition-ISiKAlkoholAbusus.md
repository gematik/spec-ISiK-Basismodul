# ISiK Alkohol Abusus - ISiK Basis Implementierungsleitfaden v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKAlkoholAbusus | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKAlkoholAbusus |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/basis|current/StructureDefinition/StructureDefinition-ISiKAlkoholAbusus.json)
