# ISiKCoding - ISiK Basis Implementierungsleitfaden v6.0.0
...
* Use this DataType Profile: [ISiKRolleImKrankenhaus](StructureDefinition-ISiKRolleImKrankenhaus.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/basis|current/StructureDefinition/StructureDefinition-ISiKCoding.json)
