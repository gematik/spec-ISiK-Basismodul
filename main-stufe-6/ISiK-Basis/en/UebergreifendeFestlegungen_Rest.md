# REST-API - ISiK Basis Implementierungsleitfaden v6.0.0
...
Instanzen von Datenobjekten, die die REST-Interaktion "READ" fordern, MÜSSEN per HTTP GET auf `[BASE_URL]/[resourceType]/[ID]` abgerufen werden können. Siehe: [RESTful API - read](https://www.hl7.org/fhir/R4/http.html#read)
