# CoverageSonstige - ISiK Basis Implementierungsleitfaden v6.0.0
...
```json
{
  ...
  "id" : "CoverageSonstige",
  "meta" : {
    "profile" : ["https://gematik.de/fhir/isik/StructureDefinition/ISiKVersicherungsverhaeltnisSonstige"]
  },
  "status" : "active",
  "type" : {
    "coding" : [{
