# ISiKVersicherungsverhaeltnisSelbstzahler - ISiK Basis Implementierungsleitfaden v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKVersicherungsverhaeltnisSelbstzahler | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKVersicherungsverhaeltnisSelbstzahler |
...
Das Selbstzahler-Profil gilt für Szenarien, in denen der Patient selbst (oder eine abweichende natürliche oder juristische Person) als Kostenträger auftritt. Für PKV-Verhältnisse, in denen die Kosten **unmittelbar** von einer privaten Versicherung übernommen werden (ohne dass der Patient in Vorleistung geht), KANN das Profil [Versicherungsdaten PKV](https://simplifier.net/vsdm2/vsdmcoveragepkv) aus der jeweils geltenden VSDM 2.0 Spezifikation verwendet werden. 
**Kompatibilität**: 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/basis|current/StructureDefinition/StructureDefinition-ISiKVersicherungsverhaeltnisSelbstzahler.json)
