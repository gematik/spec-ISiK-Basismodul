# Akteur ISiKCapabilityStatementBasisServerAkteur (Expanded) - ISiK Basis Implementierungsleitfaden v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementBasisServerAkteur-expanded | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiK-CapabilityStatementBasisServerAkteurExpanded |
...
```json
{
  ...
  "id" : "ISiKCapabilityStatementBasisServerAkteur-expanded",
  "url" : "https://gematik.de/fhir/isik/CapabilityStatement/ISiKCapabilityStatementBasisServerAkteur-expanded",
  "version" : "6.0.0",
  "name" : "ISiK-CapabilityStatementBasisServerAkteurExpanded",
  "title" : "Akteur ISiKCapabilityStatementBasisServerAkteur (Expanded)",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-07-01",
  ...
  "purpose" : "CapabilityStatement für den Akteur ISiKCapabilityStatementBasisServerAkteur.\nDieser Akteur aggregiert die Rollen zur Abfrage von Stammdaten, erweiterten Stammdaten, Aufbaustruktur, Terminologie, klinischen Daten, Abrechnungsinformationen und Gesundheitsstatus.",
  "kind" : "requirements",
  "fhirVersion" : "4.0.1",
  ...
  "rest" : [{
    ...
    },
    {
      ...
      "type" : "Organization",
      "supportedProfile" : ["https://gematik.de/fhir/isik/StructureDefinition/ISiKOrganisation",
      ...
      },
      {
        ...
        "type" : "reference",
        "documentation" : "Begründung: Die Suche nach übergeordneten Organisationseinheiten (z.B. Zugehörigkeit einer Station zu einem Fachbereich) ist eine zentrale Anforderung für die Abbildung der Aufbaustruktur.\n        **Beispiel:**    \n        `GET [base]/Organization?partof:identifier=260120196`    \n        **Anwendungshinweis:**   \n        Weitere Details siehe [FHIR-Kernspezifikation](https://hl7.org/fhir/R4/search.html#reference).  "
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation",
    ...
    },
    {
      ...
      "type" : "Observation",
      "supportedProfile" : ["https://gematik.de/fhir/isik/StructureDefinition/ISiKLebensZustand",
    ...
    },
    {
      ...
      "type" : "Device",
      "supportedProfile" : ["https://gematik.de/fhir/isik/StructureDefinition/ISiKImplantat"],
      "_supportedProfile" : [{
        "extension" : [{
          "url" : "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation",
          "valueCode" : "MAY"
