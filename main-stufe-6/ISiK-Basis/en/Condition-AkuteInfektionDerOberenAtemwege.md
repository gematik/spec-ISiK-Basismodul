# AkuteInfektionDerOberenAtemwege - ISiK Basis Implementierungsleitfaden v6.0.0
...
* **AkuteInfektionDerOberenAtemwege**

## Condition: AkuteInfektionDerOberenAtemwege

Profile: [ISiKDiagnose](StructureDefinition-ISiKDiagnose.md)

**clinicalStatus**: Active

**code**: Akute Infektion der oberen Atemwege, nicht näher bezeichnet
...
```json
{
  ...
  "code" : {
    "coding" : [{
      ...
      "version" : "2024",
      "code" : "J06.9",
      "display" : "Akute Infektion der oberen Atemwege, nicht näher bezeichnet"
    }]
  },
  "subject" : {
