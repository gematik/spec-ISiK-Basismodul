# ISiKLoincCoding - ISiK Basis Implementierungsleitfaden v6.0.0
...
* Use this DataType Profile: [ISiKBerichtSubSysteme](StructureDefinition-ISiKBerichtSubSysteme.md) and [ISiKLebensZustand](StructureDefinition-ISiKLebensZustand.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/basis|current/StructureDefinition/StructureDefinition-ISiKLoincCoding.json)
