# Herstellung von Patienten- und Besuchskontext - ISiK Basis Implementierungsleitfaden v6.0.0
...
* mit Hilfe von FHIR Subscriptions auf die SubscriptionTopics `Patient` bzw. `Encounter` (Create/Update/Delete) kann das Subsystem ereignisbasiert statt durch Polling über neue und geänderte Patienten-/Encounter-Ressourcen informiert werden und diese anschließend gezielt abrufen (siehe Modul [Subscription](https://gemspec.gematik.de/ig/fhir/isik/subscriptions/latest))
