# Repräsentationsformate - ISiK Basis Implementierungsleitfaden v6.0.0
...
Es ist zu beachten, dass die Header `Content-Type` und `Accept` noch weitere FHIR-spezifische und allgemeine Parameter enthalten können. Siehe beispielsweise [version-parameter](https://www.hl7.org/fhir/R4/http.html#version-parameter). Das Vorhandensein dieser Parameter darf nicht zu einem Fehler führen.
