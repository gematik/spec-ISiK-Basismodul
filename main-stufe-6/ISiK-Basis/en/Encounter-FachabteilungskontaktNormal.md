# FachabteilungskontaktNormal - ISiK Basis Implementierungsleitfaden v6.0.0
...
**account**: [Account: identifier = Account number; status = active](Account-AbrechnungsfallGonarthrose.md)
