# MII PR ICU Bilanz Einfuhr Saeuglingsnahrung - ISiK ICU v6.0.0
...
* **MII PR ICU Bilanz Einfuhr Saeuglingsnahrung**

## Resource Profile: MII PR ICU Bilanz Einfuhr Saeuglingsnahrung 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:MII_PR_ICU_Bilanz_Einfuhr_Saeuglingsnahrung |
...
* Examples for this Profile: [Observation/BilanzEinfuhrSaeuglingsnahrungBeispiel](Observation-BilanzEinfuhrSaeuglingsnahrungBeispiel.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-einfuhr-saeuglingsnahrung",
  "version" : "6.0.0",
