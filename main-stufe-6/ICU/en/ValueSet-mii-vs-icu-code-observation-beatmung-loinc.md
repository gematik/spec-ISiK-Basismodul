# MII VS ICU Code Observation Beatmung LOINC - ISiK ICU v6.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/ValueSet/mii-vs-icu-code-observation-beatmung-loinc | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:MII_VS_ICU_Code_Observation_Beatmung_LOINC |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/isik/ValueSet/mii-vs-icu-code-observation-beatmung-loinc",
  "version" : "6.0.0",
