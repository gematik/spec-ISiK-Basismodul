# MII PR ICU Bilanz Ausfuhr Magensonde - ISiK ICU v6.0.0
...
## Resource Profile: MII PR ICU Bilanz Ausfuhr Magensonde 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-ausfuhr-magensonde | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:MII_PR_ICU_Bilanz_Ausfuhr_Magensonde |
...
* Examples for this Profile: [Observation/BilanzAusfuhrMagensondeBeispiel](Observation-BilanzAusfuhrMagensondeBeispiel.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-ausfuhr-magensonde.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-bilanz-ausfuhr-magensonde.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-ausfuhr-magensonde.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-ausfuhr-magensonde.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-ausfuhr-magensonde",
  "version" : "6.0.0",
