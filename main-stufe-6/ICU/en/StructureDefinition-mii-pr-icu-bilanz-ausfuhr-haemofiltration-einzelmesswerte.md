# MII PR ICU Bilanz Ausfuhr Haemofiltration Einzelmesswerte - ISiK ICU v6.0.0
...
* **MII PR ICU Bilanz Ausfuhr Haemofiltration Einzelmesswerte**

## Resource Profile: MII PR ICU Bilanz Ausfuhr Haemofiltration Einzelmesswerte 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-ausfuhr-haemofiltration-einzelmesswerte | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:MII_PR_ICU_Bilanz_Ausfuhr_Haemofiltration_Einzelmesswerte |
...
* Examples for this Profile: [Observation/BilanzAusfuhrHaemofiltrationBeispiel](Observation-BilanzAusfuhrHaemofiltrationBeispiel.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-ausfuhr-haemofiltration-einzelmesswerte.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-bilanz-ausfuhr-haemofiltration-einzelmesswerte.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-ausfuhr-haemofiltration-einzelmesswerte.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-ausfuhr-haemofiltration-einzelmesswerte.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-ausfuhr-haemofiltration-einzelmesswerte",
  "version" : "6.0.0",
