# ExampleOrganPupilLightReactionLeftVerzogert20200311 - ISiK ICU v6.0.0
...
* **ExampleOrganPupilLightReactionLeftVerzogert20200311**
...
**value**: Sluggishly reactive to light

**note**: 

> 

Quelle: left pupil reaction = verzögert
...
```json
{
  ...
  "id" : "ExampleOrganPupilLightReactionLeftVerzogert20200311",
  "meta" : {
  ...
  "note" : [{
    "text" : "Quelle: left pupil reaction = verzögert"
  }],
  "bodySite" : {
    "coding" : [{
      "system" : "http://snomed.info/sct",
