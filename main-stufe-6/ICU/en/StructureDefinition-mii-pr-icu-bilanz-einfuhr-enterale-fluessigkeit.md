# MII PR ICU Bilanz Einfuhr Enterale Fluessigkeit - ISiK ICU v6.0.0
...
* **MII PR ICU Bilanz Einfuhr Enterale Fluessigkeit**

## Resource Profile: MII PR ICU Bilanz Einfuhr Enterale Fluessigkeit 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:MII_PR_ICU_Bilanz_Einfuhr_Enterale_Fluessigkeit |
...
* Examples for this Profile: [Observation/BilanzEinfuhrEnteraleFluessigkeitBeispiel](Observation-BilanzEinfuhrEnteraleFluessigkeitBeispiel.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-einfuhr-enterale-fluessigkeit",
  "version" : "6.0.0",
