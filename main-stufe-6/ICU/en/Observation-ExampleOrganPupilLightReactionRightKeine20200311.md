# ExampleOrganPupilLightReactionRightKeine20200311 - ISiK ICU v6.0.0
...
* **ExampleOrganPupilLightReactionRightKeine20200311**

## Observation: ExampleOrganPupilLightReactionRightKeine20200311
...
**value**: Not reactive to light

**note**: 

> 

Quelle: right pupil reaction = keine
...
```json
{
  ...
  "id" : "ExampleOrganPupilLightReactionRightKeine20200311",
  "meta" : {
  ...
  "note" : [{
    "text" : "Quelle: right pupil reaction = keine"
  }],
  "bodySite" : {
    "coding" : [{
      "system" : "http://snomed.info/sct",
