# ISiKHerzfrequenz - ISiK ICU v6.0.0
...
## Resource Profile: ISiKHerzfrequenz 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKHerzfrequenz | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:ISiKHerzfrequenz |
...
* Examples for this Profile: [Observation/ISiKHerzfrequenzExample](Observation-ISiKHerzfrequenzExample.md), [Observation/ISiKHerzfrequenzMaxExample](Observation-ISiKHerzfrequenzMaxExample.md) and [Observation/ISiKHerzfrequenzMinExample](Observation-ISiKHerzfrequenzMinExample.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/icu|current/StructureDefinition/StructureDefinition-ISiKHerzfrequenz.json)
...
Other representations of profile: [CSV](../StructureDefinition-ISiKHerzfrequenz.csv), [Excel](../StructureDefinition-ISiKHerzfrequenz.xlsx), [Schematron](../StructureDefinition-ISiKHerzfrequenz.sch) 
