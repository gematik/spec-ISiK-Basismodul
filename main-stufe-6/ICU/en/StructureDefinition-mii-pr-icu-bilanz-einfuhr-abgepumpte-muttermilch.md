# MII PR ICU Bilanz Einfuhr Abgepumpte Muttermilch - ISiK ICU v6.0.0
...
## Resource Profile: MII PR ICU Bilanz Einfuhr Abgepumpte Muttermilch 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-einfuhr-abgepumpte-muttermilch | *Version*:6.0.0 |
| Active as of 2026-07-01 | *Computable Name*:MII_PR_ICU_Bilanz_Einfuhr_Abgepumpte_Muttermilch |
...
* Examples for this Profile: [Observation/BilanzEinfuhrAbgepumpteMuttermilchBeispiel](Observation-BilanzEinfuhrAbgepumpteMuttermilchBeispiel.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/icu|current/StructureDefinition/StructureDefinition-mii-pr-icu-bilanz-einfuhr-abgepumpte-muttermilch.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-abgepumpte-muttermilch.csv), [Excel](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-abgepumpte-muttermilch.xlsx), [Schematron](../StructureDefinition-mii-pr-icu-bilanz-einfuhr-abgepumpte-muttermilch.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/isik/StructureDefinition/mii-pr-icu-bilanz-einfuhr-abgepumpte-muttermilch",
  "version" : "6.0.0",
