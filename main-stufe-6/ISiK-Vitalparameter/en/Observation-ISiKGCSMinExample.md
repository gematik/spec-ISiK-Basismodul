# ISiKGCSMinExample - ISiK Vitalparameter Implementierungsleitfaden v6.0.0
...
> **component****code**: Glasgow coma score verbal**value**: No verbal response (>2 yrs); no vocal response (<=2 yrs)
