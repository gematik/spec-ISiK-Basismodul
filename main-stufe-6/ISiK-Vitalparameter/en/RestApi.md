# REST-API - ISiK Vitalparameter Implementierungsleitfaden v6.0.0
...
Es gelten die Festlegungen aus dem [Basismodul](https://gemspec.gematik.de/ig/fhir/isik/basis/6.0.0-rc1/UebergreifendeFestlegungen_Rest.html).
