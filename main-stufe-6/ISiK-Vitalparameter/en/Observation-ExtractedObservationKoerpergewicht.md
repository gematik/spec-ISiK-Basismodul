# ExtractedObservationKoerpergewicht - ISiK Vitalparameter Implementierungsleitfaden v6.0.0
...
## Observation: ExtractedObservationKoerpergewicht
...
**derivedFrom**: [QuestionnaireResponse/ExampleExtractWithUnitResponse](https://simplifier.net/resolve?scope=de.basisprofil.r4@1.6.0&canonical=http://fhir.org/packages/de.basisprofil.r4/QuestionnaireResponse/ExampleExtractWithUnitResponse)
