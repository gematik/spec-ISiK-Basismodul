# Resource ISiK Vitalparameter Implementierungsleitfaden
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-09-17T12:18:46+00:00",
  ...
  "description" : "Dieser Implementierungsleitfaden beschreibt eine ISiK-konforme Umsetzung der Vitalparameter im Krankenhaus.",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementVitalSignStandardSourceAkteur.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CapabilityStatement-ISiKCapabilityStatementVitalSignStandardSourceAkteur-expanded.html"
      }],
      "reference" : {
    ...
    "page" : {
      ...
      },
      {
        ...
        "nameUrl" : "AMTS.html",
        "title" : "Konzept Arzneimitteltherapiesicherheit - AMTS",
        "generation" : "markdown"
      },
      {
        "extension" : [{
        ...
        "title" : "Überleitung Intensivversorgung im Krankenhaus",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "Festlegungen_Uebergreifend.html"
        }],
        "nameUrl" : "Festlegungen_Uebergreifend.html",
