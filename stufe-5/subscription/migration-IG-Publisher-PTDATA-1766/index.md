# Home - Test Implementation Guide v0.0.1
...
| Draft as of 2025-10-23 | *Computable Name*:TestImplementationGuide |
...
```json
{
  ...
  "id" : "example.test.ig",
  "url" : "http://example.org/fhir/test-subscription-ig/ImplementationGuide/example.test.ig",
  "version" : "0.0.1",
  "name" : "TestImplementationGuide",
  "title" : "Test Implementation Guide",
  "status" : "draft",
  "date" : "2025-10-23T15:11:01+00:00",
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://example.org/fhir/test-subscription-ig/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "page" : {
      ...
      "page" : [
        ...
        },
        {
          ...
          "title" : "Patientenzusammenführung",
          "generation" : "markdown"
        },
        {
          "extension" : [
