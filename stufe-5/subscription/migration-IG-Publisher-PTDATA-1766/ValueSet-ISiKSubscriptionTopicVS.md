# ISiKSubscriptionTopic ValueSet - Test Implementation Guide v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/ValueSet/ISiKSubscriptionTopicVS | *Version*:0.0.1 |
| Active as of 2025-06-26 | *Computable Name*:ISiKSubscriptionTopicVS |
...
* Include all codes defined in [`https://gematik.de/fhir/isik/CodeSystem/ISiKSubscriptionTopic`](CodeSystem-ISiKSubscriptionTopic.md)version 📦0.0.1
