# ISiKEKG - Test Implementation Guide v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKEKG | *Version*:0.0.1 |
| Active as of 2025-10-23 | *Computable Name*:ISiKEKG |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/vitalparameter.test.ig|current/StructureDefinition/ISiKEKG)
