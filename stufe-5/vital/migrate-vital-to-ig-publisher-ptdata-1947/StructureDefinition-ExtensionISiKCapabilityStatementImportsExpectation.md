...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/vitalparameter.test.ig|current/StructureDefinition/ExtensionISiKCapabilityStatementImportsExpectation)
