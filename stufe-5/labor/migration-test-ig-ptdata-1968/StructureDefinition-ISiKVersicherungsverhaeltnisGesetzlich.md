# ISiKVersicherungsverhaeltnisGesetzlich - Test Implementation Guide v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKVersicherungsverhaeltnisGesetzlich | *Version*:0.0.1 |
| Active as of 2025-10-23 | *Computable Name*:ISiKVersicherungsverhaeltnisGesetzlich |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/labor.test.ig|current/StructureDefinition/ISiKVersicherungsverhaeltnisGesetzlich)
