# CapabilityStatement für Rolle "ISiKCapabilityStatementKlinischeRolle" - Test Implementation Guide v0.0.1
...
| Active as of 2025-10-23 | *Computable Name*:ISiKCapabilityStatementKlinischeRolle |
...
| | | | | | | | | | |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [Procedure](#Procedure1-1) | Supported Profiles  [ISiKProzedur](StructureDefinition-ISiKProzedur.md) | **Y** | **Y** |  |  | _id, _tag, _count, _has, status, category, code, patient, subject, encounter, date | `Procedure:patient`,`Procedure:subject`,`Procedure:encounter` | `Encounter:diagnosis` |  |
| [Condition](#Condition1-2) | Supported Profiles  [ISiKDiagnose](StructureDefinition-ISiKDiagnose.md) | **Y** | **Y** |  |  | _id, _tag, _count, _has, clinical-status, patient, subject, encounter, recorded-date, related, category | `Condition:patient`,`Condition:subject`,`Condition:encounter` | `Encounter:diagnosis` |  |
