# Book - Test Implementation Guide v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/OperationDefinition/AppointmentBook | *Version*:0.0.1 |
| Active as of 2025-10-23 | *Computable Name*:Book |
...
* **Use**: IN
  ...
  * **Scope**: 
  * **Cardinality**: 1..1
  * **Type**: [Appointment](http://hl7.org/fhir/R4/appointment.html)
  * **Binding**: 
...
* **Use**: IN
  ...
  * **Scope**: 
  * **Cardinality**: 0..1
  * **Type**: [Reference](http://hl7.org/fhir/R4/references.html#Reference)([ISiKKalender](StructureDefinition-ISiKKalender.md))
  * **Binding**: 
