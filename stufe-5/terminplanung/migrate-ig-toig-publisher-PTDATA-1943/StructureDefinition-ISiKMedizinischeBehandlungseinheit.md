# ISiKMedizinischeBehandlungseinheit - Test Implementation Guide v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKMedizinischeBehandlungseinheit | *Version*:0.0.1 |
| Active as of 2025-10-23 | *Computable Name*:ISiKMedizinischeBehandlungseinheit |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/example.test.ig|current/StructureDefinition/ISiKMedizinischeBehandlungseinheit)
