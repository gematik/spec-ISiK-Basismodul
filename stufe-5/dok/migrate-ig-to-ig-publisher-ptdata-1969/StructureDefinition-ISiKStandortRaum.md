...
| Active as of 2025-10-23 | *Computable Name*:ISiKStandortRaum |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/dok.test.ig|current/StructureDefinition/ISiKStandortRaum)
