# ISiKOrganisationFachabteilung - Test Implementation Guide v0.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKOrganisationFachabteilung | *Version*:0.0.1 |
| Active as of 2025-12-11 | *Computable Name*:ISiKOrganisationFachabteilung |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/Organspendeerkennung.test.ig|current/StructureDefinition/ISiKOrganisationFachabteilung)
