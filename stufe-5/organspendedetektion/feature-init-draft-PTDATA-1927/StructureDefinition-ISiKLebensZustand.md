# ISiKLebensZustand - Test Implementation Guide v0.0.1
...
## Resource Profile: ISiKLebensZustand 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/isik/StructureDefinition/ISiKLebensZustand | *Version*:0.0.1 |
| Active as of 2025-10-23 | *Computable Name*:ISiKLebensZustand |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/Organspendeerkennung.test.ig|current/StructureDefinition/ISiKLebensZustand)
