...
Unterscheidungshinweis: Informationen zu Interaktionen mit Dokument-Binaries finden sich im Modul [ISiK Dokumentenaustausch](https://simplifier.net/guide/isik-dokumentenaustausch-stufe-5/Einfuehrung/UseCasesUndAkteure/AkteureUndInteraktionen/ErzeugenVonMetadaten.page.md?version=current).
