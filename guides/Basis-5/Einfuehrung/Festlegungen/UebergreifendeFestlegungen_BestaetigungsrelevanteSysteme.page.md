...
| :-: | :-: | :-: |
|Basis-Server|<https://simplifier.net/guide/isik-basis-stufe-5/Einfuehrung/Artefakte/CapabilityStatements/Akteur-ISiKCapabilityStatementBasisServerAkteur.page.md>|ja|
...
|**Akteur**|**konkrete Anforderungen**|**bestätigungsrelevant**|
| :-: | :-: | :-: |
|Vitalparameter-Server|<https://simplifier.net/guide/isik-vitalparameter-stufe-5>|ja|
...
|**Akteur**|**konkrete Anforderungen**|**bestätigungsrelevant**|
| :-: | :-: | :-: |
|Termin-Repository|[Guide Terminplanung](https://simplifier.net/guide/isik-terminplanung-stufe-5)|ja|
...
|**Akteur**|**konkrete Anforderungen**|**bestätigungsrelevant**|
| :-: | :-: | :-: |
|Medikations-Server|<https://simplifier.net/guide/isik-medikation-stufe-5>|ja|
|AMTS Data Provider|<https://simplifier.net/guide/isik-basis-stufe-5><br><https://simplifier.net/guide/isik-labor-stufe-5>|ja|
