...
* `fix` Fehlender LOINC-Slice in .component für ISIKBlutdurck hinzugefügt. Keine inhaltliche Änderung, Änderung betrifft nur die Validierung von Instanzen. https://github.com/gematik/spec-ISiK-Basismodul/pull/979
