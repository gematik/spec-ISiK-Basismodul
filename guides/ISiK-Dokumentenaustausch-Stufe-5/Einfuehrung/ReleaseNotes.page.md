...
Version: 5.0.0
* `added`: Löschen von vorläufigen Dokumenten durch update des docStatus auf `entered-in-error` mittels `$updateMetadata` hinzugefügt.
https://github.com/gematik/spec-ISiK-Basismodul/pull/583
