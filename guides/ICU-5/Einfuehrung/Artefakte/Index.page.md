...
Datenobjekte, die der Rolle  *VitalSign Standard Source* zugeordnet sind, werden hier nicht als eigenständige Profile geführt, sondern sind dem entsprechenden [Implementierungsleitfaden](https://simplifier.net/guide/isik-vitalparameter-stufe-5?version=current) zu entnehmen.
...
- Die Profil-Eigenschaften der MII-Profile, die den bisherigen, existenten Profilen in ISiK entsprechen, wurden in die existenten Profile des [generischen Implementierungsleitfadens Vitalparemeter](https://simplifier.net/guide/isik-vitalparameter-stufe-5?version=current) übernommen.
